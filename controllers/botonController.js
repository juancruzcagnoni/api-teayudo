...
// Controlador para eliminar un boton por su ID
exports.eliminarBoton = async (req, res) => {
  try {
    ...
    res.status(200).json({ mensaje: "Boton eliminado correctamente" });
  } catch (error) {
    res.status(500).json({ error: "Hubo un error al eliminar el boton" });
  }
};
